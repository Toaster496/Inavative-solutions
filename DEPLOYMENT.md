...
```bash
git clone (https://github.com/Toaster496/Inavative-solutions/tree/main)
cd ComputeMarket
```
...
- Check [README.md](https://github.com/Toaster496/Inavative-solutions/blob/main/README.md) for detailed documentation
